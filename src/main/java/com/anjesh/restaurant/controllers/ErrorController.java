...
import com.anjesh.restaurant.domain.dtos.ErrorDto;
import com.anjesh.restaurant.exceptions.BaseException;
import com.anjesh.restaurant.exceptions.RestaurantNotFoundException;
import com.anjesh.restaurant.exceptions.ReviewNotAllowedException;
import com.anjesh.restaurant.exceptions.StorageException;
...
public class ErrorController {
    ...
    // FIXED: Changed annotation to ReviewNotAllowedException.class
    @ExceptionHandler(ReviewNotAllowedException.class)
    public ResponseEntity<ErrorDto> handleReviewNotAllowedException(ReviewNotAllowedException ex){
        log.error("Caught ReviewNotAllowedException", ex);  // Fixed log message
    ...
    public ResponseEntity<ErrorDto> handleMethodArgumentNotValidException(MethodArgumentNotValidException ex){
        ...
        ErrorDto errorDto = ErrorDto.builder()
                .status(HttpStatus.BAD_REQUEST.value())
                .message("Validation failed: " + errorMessage)  // Document shows prefix
                .build();
        return new ResponseEntity<>(errorDto, HttpStatus.BAD_REQUEST);
    }
    ...
    public ResponseEntity<ErrorDto> handleStorageException(StorageException ex){
        ...
        ErrorDto errorDto = ErrorDto.builder()
                ...
                .message("Unable to save or recall the resource at this time")  // Document wording
                .build();
